...
namespace ConexionADO6D
{
    public partial class Form1 : Form
    {
        ...
        private void dgvDatos_SelectionChanged(object sender, EventArgs e)
        {
            ...
            #region Mapeo Grid a componentes texto
            ...
            try
            {
                ...
                if (dgvDatos.SelectedRows.Count == 1)
                {
                    ...
                    if (selec != null && selec.Cells[0].Value != null && !string.IsNullOrEmpty(selec.Cells[0].Value.ToString()))
                    {
                        ...
                        frmActualizaAutor frm = new frmActualizaAutor(_id, _Nombre, _Apellido, _Telefono, _Direccion, _Ciudad, _Estado, _CodigoPostal, _Contrato);
        ...
        private void cbEstados_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            try
            {
